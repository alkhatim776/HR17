...
class ResCompany(models.Model):
    ...
    # def _get_defalut_salary_intro_report_template(self):
    #     return self.env['mail.template'].search(
    #         [('id', '=', self.env.ref('hr_letter_request_ksa.salary_intro_report_template_id').id)])
    #
    # def _get_defalut_salary_transfer_report_template(self):
    #     return self.env['mail.template'].search(
    #         [('id', '=', self.env.ref('hr_letter_request_ksa.salary_transfer_report_template_id').id)])
    #
    # def _get_defalut_letter_of_authority_report_template(self):
    #     return self.env['mail.template'].search(
    #         [('id', '=', self.env.ref('hr_letter_request_ksa.letter_of_authority_template_id').id)])
    #
    # def _get_defalut_experience_certificate_report_template(self):
    #     return self.env['mail.template'].search(
    #         [('id', '=', self.env.ref('hr_letter_request_ksa.experience_certificate_report_template_id').id)])
